 ...
 Client Clients[10];
    ...
    string getAllClientDetails(){
        ...
        for(int i = 0;i<10;++i){
            ...
            displayString += "IP : "+Clients[i].ip +" :: Port : " +Clients[i].port + " Name : "+ Clients[i].name +" :: clientCode : "+ Clients[i].clientCode + " :: Attendance : " +  to_string(Clients[i].attendance);
            displayString += "\n";
        }
    ...
    string quit = "quit\n";
        ...
        while (true)
        {
            ...
            if (!hasLoggedIn){
                ...
                //Here we are creating client account for administration purposes
                //0->Name,1->clientCode
